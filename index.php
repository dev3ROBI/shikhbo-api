<?php
/**
 * Shikhbo Admin Panel — Premium Dark/Light Mode Router
 * Header with logo + web name · Nav below header · Premium color palette
 */
...
<!-- ===== SIDEBAR ===== -->
<aside id="sidebar" class="sidebar fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-900 shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 -translate-x-full">
...
<div class="flex-1 flex flex-col overflow-hidden">
    ...
    <!-- ===== PREMIUM HEADER WITH LOGO + WEB NAME ===== -->
    <header class="bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-900 dark:to-purple-900 shadow-lg">
        <div class="flex items-center justify-between h-16 px-4 lg:px-8">
            ...
            <div class="flex items-center space-x-1 ml-auto">
                ...
                <!-- Theme Toggle (moved here next to notifications) -->
